...
For the second, the service computes the Schnorr signature ![images/kxe.png] of a message where ![images/k.png] is a random value ![images/k.png] between 0 and q, ![images/x.png] is the private key, and ![images/e.png] is the hash ![images/gkm.png].  This is again shown below:
